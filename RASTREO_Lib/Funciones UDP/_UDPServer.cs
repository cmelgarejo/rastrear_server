...
namespace RASTREO_Lib
{
    ...
    public abstract class _UDPServer
    {
        ...
        private void AsyncBeginReceive()
        {
            ...
            if (!shutdownFlag)
            {
                ...
                catch (SocketException se)
                {
                    ...
                    //Funciones_de_soporte.Informaciones_del_sistema(se.SocketErrorCode + "\n" + se.Message + "\n" + se.StackTrace);
                    ...
                    switch (se.SocketErrorCode)
                    {
                        case SocketError.ConnectionReset:
                            ...
                            break;
                        default:
                            Funciones_de_soporte.Manejador_de_Excepciones(se);
                            break;
                    }
                    Funciones_de_soporte.Manejador_de_Excepciones(se);
